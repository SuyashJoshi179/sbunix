...
| 8 | Build BusyBox against libc.a | pending | Link errors drive remaining libc; runtime drives kernel |
...
- Current stage: Stages 1, 2, 5, 6 done; next Stage 8 (BB build attempt)
